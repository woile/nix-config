...
in
{
      ...
      settings = lib.mkOption {
        type = lib.types.submodule {
          options = {
            "email" = lib.mkOption {
              type = lib.types.str;
              default = "santiwilly@gmail.com";
              description = "Email used to configure the bastion: acme and kanidm admin email";
            };
            ...
            "vpnPrefix" = lib.mkOption {
              type = lib.types.str;
              default = "vpn";
              description = "Prefix attached to rootDomain when creating the VPN sub domain";
            };
            "authPrefix" = lib.mkOption {
              type = lib.types.str;
              default = "auth";
  ...
  config = lib.mkIf cfg.enable {
    ...
    security.acme = {
      acceptTerms = true;
      defaults.email = cfg.settings.email;
