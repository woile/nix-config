...
let
  ...
  # Checks
  hasAuthSecret = cfg.authSecretFile != null;
  ...
  options.services.netbird.relay = {
    ...
    settings = lib.mkOption {
      type = types.submodule {
        freeformType = with lib.types; nullOr (oneOf [
          str
  ...
  config = lib.mkIf cfg.enable {
    assertions = [
      ...
      }
      {
        ...
        message = "exposed-address is required";
      }
      {
    ...
    systemd.services.netbird-relay = {
      ...
      serviceConfig = {
        ...
        LoadCredential = lib.mkIf hasAuthSecret "auth_secret:${cfg.authSecretFile}";
        ...
        RestrictAddressFamilies = [
          "AF_INET"
          "AF_INET6"
          # TODO: Test if STUN works without it
          "AF_NETLINK"
        ];
        UMask = "0077";
        # Hardening::End
